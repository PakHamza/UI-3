              ...
              <div class="row justify-content-center"> 
                <div class="col-md-6 mt-5"> 
                  <form action="php/register.php" method="POST">
					...
					<br>
					The order indicates which order we will try to charge them. You can change this order by dragging cards up or down.
<div class="rcorners2" >
                    ...
                    <div class="form-group"> 
                      ...
                      <input type="radio" value="9" name="service:selected" class="pd-input-radio pd-styled-radio" id="radio-advanced-checks" checked="checked">
                            <label class="pd-input-radio-wrapperlabel" for="radio-advanced-checks"></label><b>Credit Card</b><br>
 <input type="radio" value="9" name="service:selected" class="pd-input-radio pd-styled-radio" id="radio-advanced-checks" checked="checked">
                            <label class="pd-input-radio-wrapperlabel" for="radio-advanced-checks"></label><b>Pay by Invoice (Not available)</b>
