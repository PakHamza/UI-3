                ...
                <div class="col-md-6 mt-5"> 
                  <form action="php/register.php" method="POST">
                    ...
                    <div class="form-group"> 
                      <label for="firstname">Service Type</label>
                      <br>
                      <input type="radio" value="9" name="service:selected" class="pd-input-radio pd-styled-radio" id="radio-advanced-checks" checked="checked">
                      <label class="pd-input-radio-wrapperlabel" for="radio-advanced-checks"></label>
                      5 Advanced Checks <br>
                      <small>$385.00 / year</small> </div>
                    <hr>
                    ...
                    <div class="form-group"> 
                      ...
                      <select name="phone_countrycode" class="form-control" id="inputPhonePrefix">
                        ...
                        <option value="AQ-1672" >Antarctica Scott Base (+1672)</option>
                        ...
                        <option value="BQ-599" >Bonaire, Saint Eustatius and Saba 
                        (+599)</option>
                        <option value="BA-387" >BosniaHerzegovina (+387)</option>
                        ...
                        <option value="CC-61" >Cocos Islands (+61)</option>
                        ...
                        <option value="FO-298" >Faeroe Islands (+298)</option>
                        ...
                        <option value="MQ-596" >French Antilles (Martinique) (+596)</option>
                        <option value="GF-594" >French Guiana (+594)</option>
                        <option value="PF-689" >French Polynesia (+689)</option>
                        <option value="GA-241" >Gabonese Republic (+241)</option>
                        ...
                        <option value="GW-245" >GuineaBissau (+245)</option>
                        ...
                        <option value="IM-44" >Jersey (+44)</option>
                        ...
                        <option value="FR-269" >Mayotte Island (+269)</option>
                        <option value="MX-52" >Mexico (Bands 48) (+52)</option>
                        ...
                        <option value="MP-1670" >Northern Marianas Islands (+1670)</option>
                        <option value="NO-47" >Norway (+47)</option>
                        <option value="OM-968" >Oman (+968)</option>
                        <option value="PK-92" >Pakistan (+92)</option>
                        <option value="PW-680" >Palau (+680)</option>
                        <option value="PS-970" >Palestinian National Authority 
                        (+970)</option>
                        ...
                        <option value="PN-870" >Pitcairn (+870)</option>
                        <option value="PL-48" >Poland (+48)</option>
                        <option value="PT-351" >Portugal (+351)</option>
                        <option value="PR-1787" >Puerto Rico 1 (+1787)</option>
                        <option value="PR-1939" >Puerto Rico 2 (+1939)</option>
                        <option value="QA-974" >Qatar (+974)</option>
                        <option value="RE-262" >Reunion (+262)</option>
                        <option value="FR-262" >Reunion Island (+262)</option>
                        <option value="RO-40" >Romania (+40)</option>
                        <option value="RU-7" >Russia (+7)</option>
                        <option value="RW-250" >Rwanda (+250)</option>
                        <option value="BL-590" >Saint Barthelemy (+590)</option>
                        ...
                        <option value="ST-239" >Sao Tome (+239)</option>
                        ...
                        <option value="KN-1869" >St. Kitts and Nevis (+1869)</option>
                        <option value="LC-1758" >St. Lucia (+1758)</option>
                        <option value="SX-599" >St. Maarten (+599)</option>
                        <option value="FR-508" >St. Pierre and Miguelon (+508)</option>
                        <option value="VC-1809" >St. Vincent (+1809)</option>
                        ...
                        <option value="TC-1649" >Turks and Caicos (+1649)</option>
                        <option value="TV-688" >Tuvalu (+688)</option>
                        <option value="VI-1340" >U.S. Virgin Islands (+1340)</option>
                        ...
                        <option value="UZ-998" >Uzbekistan Tashkent (+998)</option>
                        <option value="VU-678" >Vanuatu (+678)</option>
                        <option value="VA-39" >Vatican City (+39)</option>
                        <option value="VE-58" >Venezuela (+58)</option>
                        <option value="VN-84" >Vietnam (+84)</option>
                        <option value="WF-681" >Wallis And Futuna Islands (+681)</option>
                        <option value="EH-212" >Western Sahara (+212)</option>
                        <option value="WS-685" >Western Samoa (+685)</option>
                        <option value="YE-967" >Yemen (+967)</option>
                        <option value="ZM-260" >Zambia (+260)</option>
                        <option value="ZW-263" >Zimbabwe (+263)</option>
                      </select>
                      <input type="email" class="form-control-new" id="password" name="billing" >
                      <br>
                    </div>
                    <div class="form-group"> 
                    ...
                    <input id="form_custom_update_account" type="checkbox" name="updateAccount" class="pd-checkbox" />
                    <label for="form_custom_update_account">Update my Account 
                    Settings with this info</label>
                    <br>
                    <br>
                    <br>
                    <br>
