      ...
      <div class="col-lg-12"> 
        <div class="calender-inner"> 
          ...
          <div id="rbc-headings-container" class="rbc-headings-container pd-container rbc" align="right"> 
            <a href="#check=5339548" data-check-id="5339548" class="pd-js-editCheckButton pd-button pd-button-small pd-button-flr">Edit 
            check</a> </div>
          <div id="rbc-headings-container" class="rbc-headings-container pd-container rbc"> 
            <h2 style="display:inline-block;">Last 7 days (16 Jul-23 Jul)</h2>
            <br>
            <span style="color:#999;">Compared to previous period (09 Jul-16 Jul)</span> 
          </div>
          <div id="rbc-report-container" class="pd-container pd-container-padded rbc">
            <div class="pd-rbc-info-items"> 
