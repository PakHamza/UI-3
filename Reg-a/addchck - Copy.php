...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="php/addchck.php" method="POST">
    ...
    <div class="container">
	<div><center>Add Check Speed</center></div>
      ...
      <input type="text" name="name" placeholder="Enter Name"  required>
		...
		<label for="label3">Test from:</label>
 <select name="Region">
...
<br><br>
 <li> 
      ...
      <button type="submit" name="submit">Save</button> <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Cancel</button>
